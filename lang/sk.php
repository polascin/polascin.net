...
return [
    ...
    'meta.default_description' => 'Osobný a profesijný web nefrológa a internistu so zameraním na dialýzu, odborné vzdelávanie, medicínske písanie, preklady a digitálne technológie v zdravotníctve.',
    'meta.home_tagline' => 'Nefrológia, dialýza a medicínske technológie',
    ...
    'home.hero_title' => 'Presná nefrológia. Ľudská starostlivosť. Zmysluplné technológie.',
    'home.hero_subtitle' => 'Som nefrológ a internista s dlhoročnou praxou v dialýze a liečbe ochorení obličiek. Klinickú skúsenosť prepájam s odborným písaním, vzdelávaním a tvorbou digitálnych riešení pre medicínu.',
    'home.cta_about' => 'O mne',
    'home.cta_articles' => 'Najnovšie články',

    // Domovská stránka — životopis
    'home.about_heading' => 'O mne',
    'home.about_intro' => 'Som lekár so špecializáciou v nefrológii a internej medicíne. Väčšinu svojho profesijného života sa venujem ochoreniam obličiek, dialýze a starostlivosti o pacientov, ktorých liečba si vyžaduje nielen odbornú presnosť, ale aj dôveru, zrozumiteľnú komunikáciu a rešpektovanie individuálnych potrieb.',
    'home.about_who' => 'Popri klinickej práci píšem odborné aj literárne texty, venujem sa medicínskym prekladom a tvorím webové stránky a aplikácie. Programovanie a umelú inteligenciu nevnímam ako samoúčelné novinky. Sú to pre mňa praktické nástroje, ktoré môžu sprístupniť poznanie, zjednodušiť prácu a podporiť kvalitnejšie rozhodovanie v medicíne.',
    'home.about_synthesis' => 'Medicína, jazyk a technológie pre mňa nie sú oddelené oblasti. Spája ich rovnaká otázka: ako porozumieť zložitému problému a vytvoriť riešenie, ktoré je presné, zrozumiteľné a skutočne použiteľné.',

    'home.areas_heading' => 'Oblasti pôsobenia',
    'home.areas_medicine' => 'Medicína',
    'home.areas_medicine_1' => 'nefrológia a dialyzačná medicína',
    'home.areas_medicine_2' => 'interná medicína',
    'home.areas_medicine_3' => 'renálna nahradzujúca liečba',
    'home.areas_medicine_4' => 'ultrasonografia a starostlivosť o cievne prístupy',
    'home.areas_medicine_5' => 'odborné konzultácie a vzdelávanie',
    ...
    'home.areas_tech_4' => 'umelá inteligencia v medicíne',
    'home.areas_tech_5' => 'otvorený softvér a systémy Linux/Unix',

    'home.skills_heading' => 'Technologické zručnosti',
    'home.skills_web' => 'Webové technológie',
    'home.skills_web_text' => 'HTML5, CSS3, JavaScript, TypeScript, PHP',
    'home.skills_data' => 'Dáta a programovanie',
    'home.skills_data_text' => 'SQL, Python, databázové systémy, dátové spracovanie',
    ...
    'home.skills_ai_text' => 'generatívna AI, automatizácia, jazykové modely a ich praktické využitie v medicíne',

    'home.education_heading' => 'Vzdelanie a profesijná dráha',
    'home.education_text' => 'Všeobecné lekárstvo som vyštudoval na Univerzite Pavla Jozefa Šafárika v Košiciach. Po začiatkoch v internej medicíne som sa postupne zameral na nefrológiu, dialýzu a eliminačné metódy.',
    'home.education_path' => 'K nefrológii ma priviedlo prirodzené spojenie klinickej medicíny s technikou, ktorá môže bezprostredne ovplyvniť zdravotný stav a kvalitu života pacienta. Od roku 1995 sa venujem dialyzačnej liečbe a ochoreniam obličiek. V rokoch 2013 až 2022 som viedol dve dialyzačné pracoviská v Bratislave.',
    'home.education_scope' => 'Moje odborné skúsenosti zahŕňajú hemodialýzu, hemodiafiltráciu, peritoneálnu dialýzu, akútne eliminačné metódy, ultrasonografiu, starostlivosť o cievne prístupy a prípravu pacientov na transplantáciu obličky. Klinickú prax dopĺňam odborným písaním, prednášaním, vzdelávaním a tvorbou medicínskych digitálnych projektov.',

    'home.personal_heading' => 'Osobný pohľad',
    'home.personal_text' => 'Čítanie, cestovanie, filozofia, spiritualita a poézia mi pomáhajú vnímať medicínu v širších ľudských súvislostiach. Zaujímajú ma príbehy, jazyk, vedomie a otázky, ktoré presahujú hranice jedného odboru.',
    'home.personal_writing' => 'V literárnej tvorbe sa vraciam najmä k medicíne, ľudskej existencii, morálnym konfliktom a vzťahu človeka k technológiám. Aj tu hľadám to isté čo v medicíne: presnosť, pravdivosť a hlbšie porozumenie človeku.',

    'home.identity_nephrologist' => 'Nefrológ',
    'home.identity_internist' => 'Internista',

    'home.books_cta' => 'Knihy a autorská tvorba',
    'home.amazon_cta' => 'Autorský profil na Amazone',
