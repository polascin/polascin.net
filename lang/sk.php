...
return [
    ...
    'footer.updated' => 'Aktualizované:',
    'footer.beat_title' => 'Swiss Internet Time — 1 deň = 1000 beatov',
    ...
    'home.skills_data_text' => 'Python, C#, .NET, SQL, databázy a spracovanie dát',
    'home.skills_systems' => 'Systémy a infraštruktúra',
    'home.skills_systems_text' => 'Linux, Unix, Windows, macOS, iOS, iPadOS, Android, Docker, Git, slobodný a otvorený softvér',
    ...
    'home.education_school' => 'Gymnázium so zameraním na programovanie som ukončil v roku 1989 — programovalo sa vtedy v jazykoch Basic a Pascal — a vyhral som aj okresnú súťaž v programovaní.',
    ...
    'home.education_scope' => 'Moje odborné skúsenosti zahŕňajú hemodialýzu, hemodiafiltráciu, peritoneálnu dialýzu, pečeňovú dialýzu na systéme Prometheus, akútne eliminačné metódy, ultrasonografiu, starostlivosť o cievne prístupy a prípravu pacientov na transplantáciu obličky. Tieto skúsenosti prepájam s odborným písaním, prednášaním, vzdelávaním a tvorbou medicínskych digitálnych projektov.',

    'home.personal_heading' => 'Mimo medicíny',
    'home.personal_text' => 'Zaujíma ma literatúra, filozofia, poézia a cestovanie. Blízke sú mi aj cudzie jazyky — aj preto je táto stránka dostupná v desiatich z nich — a voľné chvíle trávim čítaním, prekladmi a programovaním vlastných projektov.',
    'home.personal_writing' => 'V knihách a ďalších textoch sa vraciam k medicíne, morálnym konfliktom a vzťahu človeka k technológiám. Odborné texty píšem pod vlastným menom, literárna tvorba vychádza aj pod pseudonymom Walter Kyo Csoelle — jeho autorský profil nájdete na Amazone.',
    ...
    'home.project_gumroad_text' => 'Digitálne produkty a e-knihy na platforme Gumroad — okrem iného príručka Medicínsky pôst (v angličtine Medical Fasting), bezpečnostný manuál k hladovaniu od nefrológa s protokolom Nephro-Safe Neera 2.0.',
    'home.clinics_heading' => 'Klinické pracoviská',
    ...
    'terms.updated' => 'Posledná aktualizácia: 26. septembra 2026',
    ...
    'home.link_library' => 'Knižnica textov',
    'meta.library_title' => 'Knižnica textov',
    'meta.library_description' => 'Osobná verejná knižnica textov, kníh a PDF súborov MUDr. Ľubomíra Polaščína. Texty si môžete prečítať, stiahnuť alebo vytlačiť.',
    'meta.library_404_title' => 'Text sa nenašiel',
    'meta.library_404_description' => 'Požadovaný text v knižnici nie je.',
    'library.heading' => 'Knižnica textov',
    'library.intro' => 'Texty, knihy a súbory, ktoré tu zverejňujem na čítanie, stiahnutie a tlač.',
    'library.empty' => 'Knižnica zatiaľ neobsahuje žiadny text.',
    'library.aria_label' => 'Knižnica textov',
    'library.read' => 'Čítať',
    'library.download' => 'Stiahnuť',
    'library.print' => 'Tlačiť',
    'library.back' => 'Späť do knižnice',
    'library.missing' => 'Tento text v knižnici nie je.',
    'library.go_catalog' => 'Prejsť do knižnice',
    'library.added' => 'Pridané :date',
    'library.format' => 'Formát',
