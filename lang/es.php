...
return [
    ...
    'home.about_who' => 'Mi trabajo se sitúa en la intersección de la medicina, la narración y la tecnología. La medicina afina mi precisión clínica; la escritura me permite explorar la condición humana a través de la ficción y de la no ficción; y la tecnología me impulsa a resolver problemas complejos. Como consultor, conecto estos mundos para ofrecer soluciones meditadas y bien fundamentadas.',
    'home.who_heading' => 'Quién soy',
    'home.who_approach' => 'Afronto cada reto con curiosidad y rigor, ya sea tratando a pacientes, depurando código, traduciendo un texto exigente o explorando la IA.',
    'home.bio_heading' => 'Datos biográficos',
    'home.bio_name' => 'Nombre',
    'home.bio_pronunciation' => 'Pronunciación',
    'home.bio_email' => 'Correo electrónico',
    'home.bio_web' => 'Web',
    'home.bio_social' => 'Redes sociales',
    'home.identity_heading' => 'Identidad profesional',
    'home.identity_text' => 'Soy médico, licenciado en Medicina General (1995) y especialista en Nefrología (2009). Estoy acreditado en Medicina Interna (1998) y certificado en Ecografía Abdominal en Adultos (2009).',
    'home.expertise_heading' => 'Áreas de especialización',
    'home.expertise_dialysis' => 'Diálisis y terapias de reemplazo renal (hemodiálisis, hemodiafiltración, hemofiltración)',
    'home.expertise_vascular' => 'Ecografía de accesos vasculares para diálisis',
    'home.expertise_elimination' => 'Terapias de eliminación extracorpórea e intracorpórea',
    'home.expertise_plasma' => 'Separación de plasma por membrana y terapias relacionadas',
    'home.expertise_transplant' => 'Trasplante renal',
    'home.teaching_text' => 'Tengo amplia experiencia docente y como ponente en medicina interna, diabetología, nefrología y campos afines. También trabajo como traductor especializado en traducción médica inglés–eslovaco y eslovaco–inglés, así como en localización de software.',
    'home.tech_text' => 'La tecnología de la información, la informática y la programación me acompañan desde hace tiempo. Me interesan especialmente:',
    ...
    'home.skills_heading' => 'Tecnología, informática y programación',
