...
return [
    ...
    'footer.beat_title' => 'Swiss Internet Time — 1 Tag = 1000 Beats',
    ...
    'home.skills_data_text' => 'Python, C#, .NET, SQL, Datenbanken und Datenverarbeitung',
    'home.skills_systems' => 'Systeme und Infrastruktur',
    'home.skills_systems_text' => 'Linux, Unix, Windows, macOS, iOS, iPadOS, Android, Docker, Git, freie und quelloffene Software',
    ...
    'home.education_school' => 'Das Gymnasium mit Schwerpunkt Programmierung schloss ich 1989 ab — programmiert wurde damals in Basic und Pascal — und ich gewann auch einen Programmierwettbewerb auf Bezirksebene.',
    ...
    'home.education_scope' => 'Zu meiner fachlichen Erfahrung gehören Hämodialyse, Hämodiafiltration, Peritonealdialyse, Leberdialyse mit dem Prometheus-System, akute Eliminationsverfahren, Sonografie, die Betreuung von Gefäßzugängen und die Vorbereitung von Patienten auf die Nierentransplantation. Diese Erfahrung verbinde ich mit fachlichem Schreiben, Vorträgen, Lehre und der Entwicklung medizinischer digitaler Projekte.',

    'home.personal_heading' => 'Über die Medizin hinaus',
    'home.personal_text' => 'Ich interessiere mich für Literatur, Philosophie, Poesie und Reisen. Auch Fremdsprachen liegen mir am Herzen — unter anderem deshalb ist diese Seite in zehn Sprachen verfügbar — und meine freie Zeit verbringe ich mit Lesen, Übersetzen und dem Programmieren eigener Projekte.',
    'home.personal_writing' => 'In meinen Büchern und anderen Texten kehre ich immer wieder zu Medizin, moralischen Konflikten und dem Verhältnis von Mensch und Technik zurück. Fachtexte schreibe ich unter eigenem Namen, literarische Werke erscheinen auch unter dem Pseudonym Walter Kyo Csoelle — sein Autorenprofil ist auf Amazon zu finden.',
    ...
    'home.project_gumroad_text' => 'Digitale Produkte und E-Books auf Gumroad — unter anderem Medical Fasting (auf Slowakisch Medicínsky pôst), ein Sicherheitshandbuch zum Fasten von einem Nephrologen mit dem Nephro-Safe-Protokoll Neera 2.0.',
    'home.clinics_heading' => 'Klinische Einrichtungen',
    ...
    'terms.updated' => 'Letzte Aktualisierung: 26. September 2026',
    ...
    'terms.s3_text' => 'Die Inhalte, die Struktur, die Grafiken, das Design, die Zusammenstellung sowie weitere mit dieser Website verbundene Elemente sind durch das geltende Urheberrecht und die Gesetze zum Schutz des geistigen Eigentums geschützt. Jegliches Kopieren, Weiterverbreiten, Verwenden oder Veröffentlichen dieser Elemente oder eines beliebigen Teils der Website durch den Nutzer ist strengstens untersagt. Eine Ausnahme bilden die Texte in der Textbibliothek: Sie sind zum persönlichen Lesen, Herunterladen und Drucken veröffentlicht.',
    ...
    'home.link_library' => 'Textbibliothek',
    'meta.library_title' => 'Textbibliothek',
    'meta.library_description' => 'Persönliche öffentliche Bibliothek mit Texten, Büchern und PDF-Dateien von MUDr. Ľubomír Polaščín. Sie können sie lesen, herunterladen oder drucken.',
    'meta.library_404_title' => 'Text nicht gefunden',
    'meta.library_404_description' => 'Der angeforderte Text ist nicht in der Bibliothek.',
    'library.heading' => 'Textbibliothek',
    'library.intro' => 'Texte, Bücher und Dateien, die ich hier zum Lesen, Herunterladen und Drucken veröffentliche.',
    'library.empty' => 'Die Bibliothek enthält noch keinen Text.',
    'library.aria_label' => 'Textbibliothek',
    'library.read' => 'Lesen',
    'library.download' => 'Herunterladen',
    'library.print' => 'Drucken',
    'library.back' => 'Zurück zur Bibliothek',
    'library.missing' => 'Dieser Text ist nicht in der Bibliothek.',
    'library.go_catalog' => 'Zur Bibliothek',
    'library.added' => 'Hinzugefügt :date',
