...
return [
    ...
    'meta.default_description' => 'Persönliche und berufliche Website eines Nephrologen und Internisten mit den Schwerpunkten Dialyse, Fortbildung, medizinisches Schreiben, Übersetzungen und digitale Technologien im Gesundheitswesen.',
    'meta.home_tagline' => 'Nephrologie, Dialyse und medizinische Technologien',
    ...
    'home.hero_title' => 'Präzise Nephrologie. Menschliche Zuwendung. Sinnvolle Technik.',
    'home.hero_subtitle' => 'Ich bin Nephrologe und Internist mit langjähriger Erfahrung in der Dialyse und in der Behandlung von Nierenerkrankungen. Meine klinische Erfahrung verbinde ich mit fachlichem Schreiben, mit der Lehre und mit der Entwicklung digitaler Lösungen für die Medizin.',
    'home.cta_about' => 'Über mich',
    'home.cta_articles' => 'Neueste Artikel',

    // Startseite — Lebenslauf
    'home.about_heading' => 'Über mich',
    'home.about_intro' => 'Ich bin Facharzt für Nephrologie und Innere Medizin. Den größten Teil meines Berufslebens befasse ich mich mit Nierenerkrankungen, der Dialyse und der Betreuung von Patienten, deren Behandlung nicht nur fachliche Genauigkeit erfordert, sondern auch Vertrauen, verständliche Kommunikation und Respekt vor den individuellen Bedürfnissen.',
    'home.about_who' => 'Neben der klinischen Arbeit schreibe ich Fachtexte und literarische Texte, übersetze medizinische Texte und entwickle Websites und Anwendungen. Programmierung und künstliche Intelligenz sind für mich keine Neuerungen um ihrer selbst willen. Sie sind praktische Werkzeuge, die Wissen zugänglich machen, Arbeitsabläufe vereinfachen und bessere Entscheidungen in der Medizin unterstützen können.',
    'home.about_synthesis' => 'Medizin, Sprache und Technik sind für mich keine getrennten Bereiche. Sie verbindet dieselbe Frage: wie man ein komplexes Problem versteht und daraus eine Lösung entwickelt, die genau, verständlich und tatsächlich brauchbar ist.',

    'home.areas_heading' => 'Tätigkeitsbereiche',
    'home.areas_medicine' => 'Medizin',
    'home.areas_medicine_1' => 'Nephrologie und Dialysemedizin',
    ...
    'home.areas_medicine_5' => 'fachliche Beratung und Fortbildung',
    'home.areas_language' => 'Sprache und Autorentätigkeit',
    ...
    'home.areas_tech_4' => 'künstliche Intelligenz in der Medizin',
    'home.areas_tech_5' => 'quelloffene Software und Linux/Unix-Systeme',

    'home.skills_heading' => 'Technische Fähigkeiten',
    'home.skills_web' => 'Webtechnologien',
    'home.skills_web_text' => 'HTML5, CSS3, JavaScript, TypeScript, PHP',
    'home.skills_data' => 'Daten und Programmierung',
    'home.skills_data_text' => 'SQL, Python, Datenbanksysteme, Datenverarbeitung',
    ...
    'home.skills_ai_text' => 'generative KI, Automatisierung, Sprachmodelle und ihr praktischer Einsatz in der Medizin',

    'home.education_heading' => 'Ausbildung und beruflicher Werdegang',
    'home.education_text' => 'Humanmedizin habe ich an der Pavol-Jozef-Šafárik-Universität in Košice studiert. Nach den Anfängen in der Inneren Medizin habe ich mich zunehmend auf Nephrologie, Dialyse und Eliminationsverfahren konzentriert.',
    'home.education_path' => 'Zur Nephrologie kam ich über die natürliche Verbindung von klinischer Medizin und Technik, die den Gesundheitszustand und die Lebensqualität der Patienten unmittelbar beeinflussen kann. Seit 1995 befasse ich mich mit der Dialysebehandlung und mit Nierenerkrankungen. Von 2013 bis 2022 habe ich zwei Dialysezentren in Bratislava geleitet.',
    'home.education_scope' => 'Zu meiner fachlichen Erfahrung gehören Hämodialyse, Hämodiafiltration, Peritonealdialyse, akute Eliminationsverfahren, Sonografie, die Betreuung von Gefäßzugängen und die Vorbereitung von Patienten auf die Nierentransplantation. Die klinische Arbeit ergänze ich durch fachliches Schreiben, Vorträge, Lehre und die Entwicklung medizinischer digitaler Projekte.',

    'home.personal_heading' => 'Persönliche Sicht',
    'home.personal_text' => 'Lesen, Reisen, Philosophie, Spiritualität und Poesie helfen mir, die Medizin in größeren menschlichen Zusammenhängen zu sehen. Mich interessieren Geschichten, Sprache, Bewusstsein und Fragen, die über die Grenzen eines einzelnen Fachs hinausreichen.',
    'home.personal_writing' => 'In meinen literarischen Texten kehre ich vor allem zur Medizin, zur menschlichen Existenz, zu moralischen Konflikten und zum Verhältnis des Menschen zur Technik zurück. Auch dort suche ich dasselbe wie in der Medizin: Genauigkeit, Wahrhaftigkeit und ein tieferes Verständnis des Menschen.',

    'home.identity_nephrologist' => 'Nephrologe',
    'home.identity_internist' => 'Internist',

    'home.books_cta' => 'Bücher und Autorentätigkeit',
