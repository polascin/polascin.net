...
return [
    ...
    // Stopka
    'footer.heading' => 'Kontakt i profile',
    ...
    'meta.home_tagline' => 'Nefrologia, edukacja medyczna i narzędzia cyfrowe',
    'meta.articles_title' => 'Artykuły',
    'meta.articles_description' => 'Najnowsze artykuły i spostrzeżenia MUDr. Ľubomíra Polaščína o nefrologii, chorobach wewnętrznych, technologii i pisaniu.',
    ...
    'meta.contact_description' => 'Skontaktuj się z MUDr. Ľubomírem Polaščínem w sprawach zawodowych, propozycji współpracy lub pytań.',
    ...
    'meta.privacy_description' => 'Polityka prywatności serwisu MUDr. Ľubomíra Polaščína.',
    'meta.terms_title' => 'Warunki korzystania',
    'meta.terms_description' => 'Warunki korzystania z serwisu MUDr. Ľubomíra Polaščína.',

    // Strona główna — sekcja powitalna
    'home.logo_alt' => 'Crystal Kidney',
    'home.hero_title' => 'MUDr. Ľubomír Polaščín',
    'home.hero_subtitle' => 'Jestem nefrologiem i internistą, edukatorem medycznym i autorem. Wieloletnie doświadczenie w dializoterapii wykorzystuję w pisarstwie specjalistycznym, tłumaczeniach i tworzeniu praktycznych narzędzi cyfrowych.',
    'home.cta_about' => 'Czym się zajmuję',
    'home.cta_articles' => 'Czytaj artykuły',

    // Strona główna — życiorys
    'home.about_heading' => 'O mnie',
    'home.about_intro' => 'Jestem lekarzem specjalizującym się w nefrologii i chorobach wewnętrznych. Moja praca zawodowa koncentruje się na dializoterapii i chorobach nerek; kierowałem dwoma ośrodkami dializ w Bratysławie i zajmowałem się edukacją medyczną.',
    'home.about_who' => 'Piszę teksty specjalistyczne i literackie, tłumaczę treści medyczne między językiem słowackim a angielskim oraz tworzę strony internetowe i aplikacje. Technologie i sztuczną inteligencję oceniam według ich praktycznej wartości: czy ułatwiają dostęp do wiedzy, usprawniają pracę lub podnoszą jakość rezultatu.',
    'home.about_synthesis' => 'W medycynie, języku i kodzie postępuję podobnie: precyzyjnie definiuję problem, weryfikuję istotne fakty, zaznaczam niepewność i tworzę jasny, użyteczny rezultat.',

    'home.areas_heading' => 'Czym się zajmuję',
    'home.areas_medicine' => 'Nefrologia i edukacja',
    ...
    'home.areas_medicine_5' => 'wykłady specjalistyczne i edukacja',
    'home.areas_language' => 'Pisarstwo i tłumaczenia',
    ...
    'home.areas_tech' => 'Projekty cyfrowe',
    ...
    'home.areas_tech_4' => 'krytyczne i praktyczne wykorzystanie sztucznej inteligencji',
    'home.areas_tech_5' => 'otwarte oprogramowanie oraz systemy Linux/Unix',

    'home.skills_heading' => 'Narzędzia i technologie',
    'home.skills_web' => 'Technologie internetowe',
    'home.skills_web_text' => 'HTML5, CSS3, JavaScript, TypeScript, PHP, React, Vue, Node.js',
    'home.skills_data' => 'Programowanie i dane',
    'home.skills_data_text' => 'Python, C#, .NET, SQL, bazy danych i przetwarzanie danych',
    'home.skills_systems' => 'Systemy i infrastruktura',
    'home.skills_systems_text' => 'Linux, Unix, Windows, macOS, iOS, iPadOS, Android, Docker, Git, wolne i otwarte oprogramowanie',
    'home.skills_ai' => 'Sztuczna inteligencja',
    'home.skills_ai_text' => 'modele językowe, automatyzacja i krytyczna ocena ich zastosowania w medycynie',

    'home.education_heading' => 'Wykształcenie i droga zawodowa',
    'home.education_school' => 'Liceum o profilu programistycznym ukończyłem w 1989 roku — programowało się wtedy w językach Basic i Pascal — wygrałem też powiatowy konkurs programistyczny.',
    'home.education_text' => 'Studia na kierunku lekarskim ukończyłem na Uniwersytecie Pavla Jozefa Šafárika w Koszycach w 1995 roku. W 1998 roku uzyskałem specjalizację z chorób wewnętrznych, a w 2009 roku z nefrologii; w tym samym roku otrzymałem także certyfikat z ultrasonografii jamy brzusznej u dorosłych.',
    'home.education_path' => 'Od 1995 roku pracuję w dializoterapii i nefrologii. Później kierowałem dwoma ośrodkami dializ w Bratysławie i zajmowałem się edukacją medyczną.',
    'home.education_scope' => 'Moje doświadczenie zawodowe obejmuje hemodializę, hemodiafiltrację, dializę otrzewnową, dializę wątrobową w systemie Prometheus, metody eliminacyjne stosowane w stanach ostrych, ultrasonografię, opiekę nad dostępami naczyniowymi oraz przygotowanie pacjentów do przeszczepienia nerki. Łączę te doświadczenia z pisaniem tekstów specjalistycznych, wykładami, nauczaniem i tworzeniem medycznych projektów cyfrowych.',

    'home.personal_heading' => 'Poza medycyną',
    'home.personal_text' => 'Interesuję się literaturą, filozofią, poezją i podróżami. Bliskie są mi także języki obce — między innymi dlatego ta strona jest dostępna w dziesięciu z nich — a wolne chwile spędzam na czytaniu, tłumaczeniach i programowaniu własnych projektów.',
    'home.personal_writing' => 'W książkach i innych tekstach wracam do medycyny, konfliktów moralnych i relacji człowieka z technologią. Teksty specjalistyczne piszę pod własnym nazwiskiem, a twórczość literacka ukazuje się także pod pseudonimem Walter Kyo Csoelle — jego profil autorski można znaleźć w serwisie Amazon.',

    'home.identity_nephrologist' => 'Nefrolog',
    'home.identity_internist' => 'Internista',

    'home.books_cta' => 'Zobacz książki',
    'home.amazon_cta' => 'Profil autora na Amazonie',

    // Strona główna — nefrologia
    'home.nephrology_heading' => 'Nefrologia w skrócie',
    'home.nephrology_intro' => 'Nefrologia to nie tylko dializoterapia. Łączy profilaktykę, wczesne rozpoznawanie i długoterminowe leczenie chorób nerek z leczeniem nerkozastępczym, gdy postępowanie zachowawcze przestaje wystarczać.',
    'home.ckd_title' => 'Przewlekła choroba nerek (PChN)',
    'home.ckd_text' => 'Przewlekła choroba nerek oznacza długotrwałe uszkodzenie nerek lub obniżenie ich czynności. Często współistnieje z cukrzycą albo nadciśnieniem tętniczym i wymaga regularnego monitorowania, leczenia przyczyn oraz działań ograniczających dalsze pogarszanie się funkcji nerek.',
    'home.aki_title' => 'Ostre uszkodzenie nerek (OUN)',
    'home.aki_text' => 'Ostre uszkodzenie nerek to nagła utrata ich funkcji. Może wystąpić podczas ciężkiej choroby, odwodnienia, niedrożności dróg moczowych albo wskutek działania niektórych leków i toksyn.',
    'home.hemodialysis_title' => 'Hemodializa',
    'home.hemodialysis_text' => 'Podczas hemodializy krew przepływa przez dializator, który usuwa produkty przemiany materii i nadmiar płynu oraz pomaga przywrócić równowagę środowiska wewnętrznego organizmu.',
    'home.peritoneal_title' => 'Dializa otrzewnowa',
    'home.peritoneal_text' => 'Dializa otrzewnowa wykorzystuje otrzewną jako naturalną błonę dializacyjną. Płyn dializacyjny wprowadza się do jamy brzusznej i usuwa po zaleconym czasie zalegania.',
    'home.transplant_title' => 'Przeszczepienie',
    'home.transplant_text' => 'U odpowiednio zakwalifikowanych pacjentów przeszczepienie nerki może zapewnić lepsze przeżycie i jakość życia niż długotrwała dializoterapia. Wymaga starannej kwalifikacji, dożywotniej kontroli i leczenia immunosupresyjnego.',
    'home.diagnostics_title' => 'Diagnostyka',
    'home.diagnostics_text' => 'Rozpoznanie opiera się na wywiadzie, badaniu fizykalnym, badaniach krwi i moczu oraz diagnostyce obrazowej. Biopsję nerki wykonuje się, gdy istnieją wskazania kliniczne.',
    'home.nephrology_note' => 'Informacje mają charakter edukacyjny i nie zastępują badania lekarskiego ani indywidualnej porady.',
    ...
    'home.projects_heading' => 'Wybrane projekty',
    'home.projects_intro' => 'Projekty, które tworzę lub długoterminowo rozwijam w dziedzinie medycyny, edukacji i technologii.',
    'home.project_nefro_text' => 'Słowacki portal z artykułami specjalistycznymi, aktualnościami klinicznymi, kalkulatorami, materiałami referencyjnymi o lekach i zasobami do nauki nefrologii.',
    'home.project_nephrosite_text' => 'Archiwum słowackich wykładów i materiałów referencyjnych o nefrologii, dializoterapii, metodach oczyszczania krwi i chorobach wewnętrznych.',
    ...
    'home.link_dialysis_bratislava' => 'Dializa w Bratysławie: Medimpax (po słowacku)',
    'home.link_impax_centres' => 'Ośrodki dializ IMPAX (po słowacku)',
    ...
    'home.contact_intro' => 'W sprawie współpracy specjalistycznej, wykładu, tłumaczenia medycznego lub projektu cyfrowego wyślij mi wiadomość. Ten kontakt nie jest przeznaczony do pilnych pytań medycznych.',
    'home.contact_cta' => 'Otwórz formularz kontaktowy',
    ...
    'newsletter.intro' => 'Zapisz się, aby otrzymywać e-mailem informacje o nowych artykułach, książkach i projektach.',
    ...
    'cookie.description' => 'Za Twoją zgodą korzystam z Google Analytics 4 do pomiaru odwiedzin. Bez zgody analityka nie zostanie wczytana, a funkcje reklamowe pozostaną wyłączone. Szczegóły znajdują się w',
    'cookie.privacy_link' => 'polityce prywatności',
    'cookie.decline' => 'Odmawiam',
    'cookie.accept' => 'Zezwól na analitykę',
    ...
    'privacy.s2_cookies' => '<strong>Pliki cookie i pamięć lokalna:</strong> Lokalnie przechowuję wyłącznie preferencję motywu (tryb ciemny/jasny), wybrany język oraz Twoją decyzję dotyczącą analityki. <strong>Google Analytics 4 (GA4):</strong> Skrypt analityczny nie jest ładowany, dopóki wyraźnie nie klikniesz przycisku Zezwól na analitykę na pasku zgody. Reklamowe kategorie zgody pozostają wyłączone. Swoją decyzję możesz zmienić w dowolnej chwili przez Ustawienia plików cookie w stopce.',
    ...
    'privacy.s3_item5' => 'Analizy ruchu i sposobów korzystania z serwisu za pomocą Google Analytics 4, ale wyłącznie jeśli klikniesz przycisk <strong>Zezwól na analitykę</strong> na pasku zgody na pliki cookie. Podstawa prawna: Twoja zgoda (art. 6 ust. 1 lit. a RODO). Dane analityczne przechowuje Google zgodnie z własnymi zasadami retencji (zwykle nie dłużej niż 14 miesięcy). Zgodę możesz wycofać w dowolnej chwili przyciskiem <strong>Ustawienia plików cookie</strong> w stopce, wybierając opcję <strong>Odmawiam</strong>.',
    ...
    'terms.updated' => 'Ostatnia aktualizacja: 26 września 2026',
    ...
    'home.link_library' => 'Biblioteka tekstów',
    'meta.library_title' => 'Biblioteka tekstów',
    'meta.library_description' => 'Osobista publiczna biblioteka tekstów, książek i plików PDF MUDr. Ľubomíra Polaščína. Można je czytać, pobierać i drukować.',
    'meta.library_404_title' => 'Nie znaleziono tekstu',
    'meta.library_404_description' => 'Żądanego tekstu nie ma w bibliotece.',
    'library.heading' => 'Biblioteka tekstów',
    'library.intro' => 'Teksty, książki i pliki, które publikuję tutaj do czytania, pobierania i drukowania.',
    'library.empty' => 'Biblioteka nie zawiera jeszcze żadnego tekstu.',
    'library.aria_label' => 'Biblioteka tekstów',
    'library.read' => 'Czytaj',
    'library.download' => 'Pobierz',
    'library.print' => 'Drukuj',
    'library.back' => 'Wróć do biblioteki',
    'library.missing' => 'Tego tekstu nie ma w bibliotece.',
    'library.go_catalog' => 'Przejdź do biblioteki',
    'library.added' => 'Dodano :date',
