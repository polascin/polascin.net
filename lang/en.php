...
return [
    ...
    'meta.default_description' => 'The personal and professional website of a nephrologist and internist, focused on dialysis, professional education, medical writing, translation and digital technology in healthcare.',
    'meta.home_tagline' => 'Nephrology, dialysis and medical technology',
    ...
    'home.hero_title' => 'Precision nephrology. Humane care. Meaningful technology.',
    'home.hero_subtitle' => 'I am a nephrologist and internist with many years of practice in dialysis and the treatment of kidney disease. I combine clinical experience with professional writing, teaching and the development of digital solutions for medicine.',
    'home.cta_about' => 'About me',
    'home.cta_articles' => 'Latest articles',

    // Home page — biography
    'home.about_heading' => 'About me',
    'home.about_intro' => 'I am a physician specialising in nephrology and internal medicine. Most of my professional life has been devoted to kidney disease, dialysis and the care of patients whose treatment calls not only for clinical accuracy, but also for trust, clear communication and respect for individual needs.',
    'home.about_who' => 'Alongside my clinical work I write both professional and literary texts, do medical translation, and build websites and applications. I do not regard programming and artificial intelligence as novelties pursued for their own sake. To me they are practical tools that can make knowledge accessible, simplify work and support better decision-making in medicine.',
    'home.about_synthesis' => 'Medicine, language and technology are not separate fields for me. They share the same question: how to understand a complex problem and create a solution that is accurate, clear and genuinely usable.',

    'home.areas_heading' => 'Areas of work',
    'home.areas_medicine' => 'Medicine',
    'home.areas_medicine_1' => 'nephrology and dialysis',
    'home.areas_medicine_2' => 'internal medicine',
    'home.areas_medicine_3' => 'renal replacement therapy',
    'home.areas_medicine_4' => 'ultrasonography and vascular access care',
    'home.areas_medicine_5' => 'specialist consultations and teaching',
    'home.areas_language' => 'Language and writing',
    ...
    'home.areas_tech_4' => 'artificial intelligence in medicine',
    ...
    'home.skills_data' => 'Data and programming',
    'home.skills_data_text' => 'SQL, Python, database systems, data processing',
    'home.skills_systems' => 'Systems and infrastructure',
    'home.skills_systems_text' => 'Linux, Unix, free and open-source software',
    'home.skills_ai' => 'Artificial intelligence',
    'home.skills_ai_text' => 'generative AI, automation, language models and their practical use in medicine',

    'home.education_heading' => 'Education and career',
    'home.education_text' => 'I studied general medicine at Pavol Jozef Šafárik University in Košice. After starting out in internal medicine, I gradually moved towards nephrology, dialysis and extracorporeal blood purification techniques.',
    'home.education_path' => 'I came to nephrology through the natural link between clinical medicine and technology that can directly affect a patient\'s health and quality of life. Since 1995 I have worked in dialysis and the treatment of kidney disease. Between 2013 and 2022 I headed two dialysis centres in Bratislava.',
    'home.education_scope' => 'My professional experience covers haemodialysis, haemodiafiltration, peritoneal dialysis, acute extracorporeal blood purification, ultrasonography, vascular access care and the preparation of patients for kidney transplantation. Alongside clinical practice I write on specialist topics, lecture, teach and develop digital medical projects.',

    'home.personal_heading' => 'A personal note',
    'home.personal_text' => 'Reading, travel, philosophy, spirituality and poetry help me see medicine in a wider human context. I am interested in stories, language, consciousness and questions that reach beyond the boundaries of a single discipline.',
    'home.personal_writing' => 'In my literary work I return above all to medicine, human existence, moral conflict and our relationship with technology. Here too I look for the same things as in medicine: accuracy, truthfulness and a deeper understanding of the person.',

    'home.identity_nephrologist' => 'Nephrologist',
    'home.identity_internist' => 'Internist',

    'home.books_cta' => 'Books and writing',
    'home.amazon_cta' => 'Author profile on Amazon',
