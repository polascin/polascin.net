...
return [
    ...
    'meta.default_description' => 'Site personnel et professionnel d\'un néphrologue et interniste, consacré à la dialyse, à l\'enseignement, à l\'écriture médicale, à la traduction et aux technologies numériques en santé.',
    'meta.home_tagline' => 'Néphrologie, dialyse et technologies médicales',
    ...
    'home.hero_title' => 'Une néphrologie précise. Des soins humains. Des technologies qui ont du sens.',
    'home.hero_subtitle' => 'Je suis néphrologue et interniste, avec une longue expérience de la dialyse et du traitement des maladies rénales. J\'associe mon expérience clinique à l\'écriture scientifique, à l\'enseignement et au développement de solutions numériques pour la médecine.',
    ...
    'home.about_intro' => 'Je suis médecin, spécialiste en néphrologie et en médecine interne. Je consacre l\'essentiel de ma vie professionnelle aux maladies rénales, à la dialyse et à la prise en charge de patients dont le traitement exige non seulement une rigueur professionnelle, mais aussi de la confiance, une communication claire et le respect des besoins de chacun.',
    'home.about_who' => 'Parallèlement à mon activité clinique, j\'écris des textes scientifiques et littéraires, je réalise des traductions médicales et je développe des sites web et des applications. Je ne vois pas dans la programmation et l\'intelligence artificielle des nouveautés qui seraient une fin en soi. J\'y vois des outils pratiques, capables de rendre le savoir accessible, de simplifier le travail et de contribuer à de meilleures décisions en médecine.',
    'home.about_synthesis' => 'La médecine, la langue et les technologies ne sont pas pour moi des domaines séparés. Une même question les relie : comment comprendre un problème complexe et concevoir une solution précise, intelligible et réellement utilisable.',

    'home.areas_heading' => 'Domaines d\'activité',
    'home.areas_medicine' => 'Médecine',
    'home.areas_medicine_1' => 'néphrologie et médecine de dialyse',
    'home.areas_medicine_2' => 'médecine interne',
    'home.areas_medicine_3' => 'thérapies de suppléance rénale',
    'home.areas_medicine_4' => 'échographie et prise en charge des abords vasculaires',
    'home.areas_medicine_5' => 'consultations spécialisées et enseignement',
    'home.areas_language' => 'Langue et écriture',
    ...
    'home.areas_tech_4' => 'intelligence artificielle en médecine',
    ...
    'home.skills_data' => 'Données et programmation',
    'home.skills_data_text' => 'SQL, Python, systèmes de bases de données, traitement des données',
    ...
    'home.skills_ai_text' => 'IA générative, automatisation, modèles de langage et leurs applications pratiques en médecine',

    'home.education_heading' => 'Formation et parcours professionnel',
    'home.education_text' => 'J\'ai fait mes études de médecine à l\'Université Pavol Jozef Šafárik de Košice. Après des débuts en médecine interne, je me suis progressivement orienté vers la néphrologie, la dialyse et les techniques d\'épuration extrarénale.',
    'home.education_path' => 'Ce qui m\'a conduit à la néphrologie, c\'est l\'alliance naturelle entre la médecine clinique et une technique capable d\'agir directement sur l\'état de santé et la qualité de vie du patient. Depuis 1995, je me consacre au traitement par dialyse et aux maladies rénales. De 2013 à 2022, j\'ai dirigé deux centres de dialyse à Bratislava.',
    'home.education_scope' => 'Mon expérience couvre l\'hémodialyse, l\'hémodiafiltration, la dialyse péritonéale, l\'épuration extrarénale en situation aiguë, l\'échographie, la prise en charge des abords vasculaires et la préparation des patients à la transplantation rénale. À la pratique clinique s\'ajoutent l\'écriture scientifique, les conférences, l\'enseignement et la création de projets numériques en médecine.',

    'home.personal_heading' => 'Regard personnel',
    'home.personal_text' => 'La lecture, les voyages, la philosophie, la spiritualité et la poésie m\'aident à replacer la médecine dans un contexte humain plus large. Je m\'intéresse aux récits, à la langue, à la conscience et aux questions qui débordent le cadre d\'une seule discipline.',
    'home.personal_writing' => 'Dans mes textes littéraires, je reviens surtout à la médecine, à l\'existence humaine, aux conflits moraux et au rapport de l\'homme aux technologies. J\'y cherche la même chose qu\'en médecine : la précision, la vérité et une compréhension plus profonde de l\'être humain.',

    'home.identity_nephrologist' => 'Néphrologue',
    'home.identity_internist' => 'Interniste',

    'home.books_cta' => 'Livres et écrits',
