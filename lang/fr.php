...
return [
    ...
    'home.about_who' => 'Mon travail se situe au croisement de la médecine, de l\'art du récit et des technologies. La médecine affine ma rigueur clinique ; l\'écriture me permet d\'explorer la condition humaine à travers la fiction et la non-fiction ; et les technologies me poussent à résoudre des problèmes complexes. En tant que consultant, je relie ces mondes pour proposer des solutions réfléchies et bien documentées.',
    'home.who_heading' => 'Qui je suis',
    'home.who_approach' => 'J\'aborde chaque défi avec curiosité et rigueur — que je soigne des patients, que je débogue du code, que je traduise un texte exigeant ou que j\'explore l\'IA.',
    'home.bio_heading' => 'Informations biographiques',
    'home.bio_name' => 'Nom',
    'home.bio_pronunciation' => 'Prononciation',
    'home.bio_email' => 'E-mail',
    'home.bio_web' => 'Web',
    'home.bio_social' => 'Réseaux sociaux',
    'home.identity_heading' => 'Identité professionnelle',
    'home.identity_text' => 'Je suis médecin, diplômé en médecine générale (1995) et spécialisé en néphrologie (2009). Je suis qualifié en médecine interne (1998) et certifié en échographie abdominale chez l\'adulte (2009).',
    'home.expertise_heading' => 'Domaines d\'expertise',
    'home.expertise_dialysis' => 'Dialyse et thérapies de suppléance rénale (hémodialyse, hémodiafiltration, hémofiltration)',
    'home.expertise_vascular' => 'Échographie des abords vasculaires pour la dialyse',
    'home.expertise_elimination' => 'Thérapies d\'épuration extracorporelle et intracorporelle',
    'home.expertise_plasma' => 'Séparation plasmatique sur membrane et thérapies associées',
    'home.expertise_transplant' => 'Transplantation rénale',
    'home.teaching_text' => 'J\'ai une longue expérience de l\'enseignement et de la conférence en médecine interne, diabétologie, néphrologie et disciplines connexes. Je travaille également comme traducteur spécialisé en traduction médicale anglais–slovaque et slovaque–anglais ainsi qu\'en localisation de logiciels.',
    'home.tech_text' => 'Les technologies de l\'information, l\'informatique et la programmation m\'accompagnent depuis longtemps. Je m\'intéresse notamment à :',
    ...
    'home.skills_heading' => 'Technologies, informatique et programmation',
