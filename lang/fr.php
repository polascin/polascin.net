...
return [
    ...
    'home.skills_data_text' => 'Python, C#, .NET, SQL, bases de données et traitement des données',
    'home.skills_systems' => 'Systèmes et infrastructure',
    'home.skills_systems_text' => 'Linux, Unix, Windows, macOS, iOS, iPadOS, Android, Docker, Git, logiciels libres et open source',
    ...
    'home.education_school' => 'J\'ai terminé le lycée avec une spécialisation en programmation en 1989 — on programmait alors en Basic et en Pascal — et j\'ai également remporté un concours de programmation au niveau du district.',
    ...
    'home.education_scope' => 'Mon expérience couvre l\'hémodialyse, l\'hémodiafiltration, la dialyse péritonéale, la dialyse hépatique sur le système Prometheus, l\'épuration extrarénale en situation aiguë, l\'échographie, la prise en charge des abords vasculaires et la préparation des patients à la transplantation rénale. J\'associe cette expérience à l\'écriture scientifique, aux conférences, à l\'enseignement et à la création de projets numériques en médecine.',

    'home.personal_heading' => 'Au-delà de la médecine',
    'home.personal_text' => 'Je m\'intéresse à la littérature, à la philosophie, à la poésie et aux voyages. Les langues étrangères me tiennent également à cœur — c\'est notamment pour cela que ce site est disponible en dix langues — et je consacre mon temps libre à la lecture, à la traduction et à la programmation de mes propres projets.',
    'home.personal_writing' => 'Dans mes livres et mes autres écrits, je reviens à la médecine, aux conflits moraux et aux relations entre les personnes et la technologie. Je publie mes textes spécialisés sous mon propre nom, tandis que mon œuvre littéraire paraît aussi sous le pseudonyme de Walter Kyo Csoelle — dont le profil d\'auteur est disponible sur Amazon.',
    ...
    'terms.updated' => 'Dernière mise à jour : 26 septembre 2026',
    ...
    'terms.s3_text' => 'Le contenu, la structure, les graphismes, le design, la compilation et les autres éléments liés à ce site web sont protégés par le droit d\'auteur et par les lois applicables en matière de propriété intellectuelle. Toute copie, redistribution, utilisation ou publication de ces éléments, ou de toute partie du site web, par les utilisateurs est strictement interdite. Les textes de la bibliothèque de textes font exception : ils sont publiés pour une lecture, un téléchargement et une impression à titre personnel.',
    ...
    'home.link_library' => 'Bibliothèque de textes',
    'meta.library_title' => 'Bibliothèque de textes',
    'meta.library_description' => 'Bibliothèque publique personnelle de textes, de livres et de fichiers PDF de MUDr. Ľubomír Polaščín. Vous pouvez les lire, les télécharger ou les imprimer.',
    'meta.library_404_title' => 'Texte introuvable',
    'meta.library_404_description' => 'Le texte demandé ne figure pas dans la bibliothèque.',
    'library.heading' => 'Bibliothèque de textes',
    'library.intro' => 'Textes, livres et fichiers que je publie ici pour la lecture, le téléchargement et l’impression.',
    'library.empty' => 'La bibliothèque ne contient encore aucun texte.',
    'library.aria_label' => 'Bibliothèque de textes',
    'library.read' => 'Lire',
    'library.download' => 'Télécharger',
    'library.print' => 'Imprimer',
    'library.back' => 'Retour à la bibliothèque',
    'library.missing' => 'Ce texte ne figure pas dans la bibliothèque.',
    'library.go_catalog' => 'Aller à la bibliothèque',
    'library.added' => 'Ajouté le :date',
