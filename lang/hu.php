...
return [
    ...
    'meta.default_description' => 'Dr. Ľubomír Polaščín — nefrológus, belgyógyász, orvosi szakfordító, író és autodidakta programozó.',
    'meta.home_title' => 'Kezdőlap',
    ...
    // Kezdőlap — fejrész
    'home.logo_alt' => 'Crystal Kidney logó',
    'home.hero_title' => 'Előrelépés a vesék egészségéért',
    'home.hero_subtitle' => 'Dr. Ľubomír Polaščín — elkötelezett a nefrológia, a dialízis, a betegellátás és az orvostechnológia kiválósága iránt.',
    'home.cta_about' => 'Rólam',
    'home.cta_articles' => 'Legújabb cikkek',

    // Kezdőlap — életrajz
    'home.about_heading' => 'Dr. Ľubomír Polaščínról',
    'home.about_intro' => 'Ľubomír Polaščín vagyok — hivatásom szerint orvos, nefrológus és belgyógyász, elhivatottságból szépirodalmi és tényirodalmi szerző, szenvedélyből pedig autodidakta programozó.',
    'home.about_who' => 'Munkám az orvoslás, a történetmesélés és a technológia metszéspontjában áll. Az orvoslás élesíti a klinikai pontosságomat; az írás lehetővé teszi, hogy szépirodalmon és tényirodalmon keresztül vizsgáljam az emberi létet; a technológia pedig előrevisz az összetett problémák megoldásában. Tanácsadóként ezeket a világokat kapcsolom össze, és átgondolt, jól megalapozott megoldásokat nyújtok.',
    'home.who_heading' => 'Ki vagyok',
    'home.who_approach' => 'Minden kihívást kíváncsisággal és alapossággal közelítek meg — akár betegeket kezelek, akár kódot hibakeresek, igényes szöveget fordítok vagy a mesterséges intelligenciát kutatom.',
    'home.bio_heading' => 'Életrajzi adatok',
    'home.bio_name' => 'Név',
    'home.bio_pronunciation' => 'Kiejtés',
    'home.bio_email' => 'E-mail',
    'home.bio_web' => 'Web',
    'home.bio_social' => 'Közösségi oldalak',
    'home.identity_heading' => 'Szakmai identitás',
    'home.identity_text' => 'Orvos vagyok, általános orvosi diplomámat 1995-ben szereztem, nefrológiából 2009-ben szakvizsgáztam. Belgyógyászatból 1998-ban szereztem szakképesítést, felnőttek hasi ultrahangdiagnosztikájából pedig 2009-ben tanúsítványt.',
    'home.expertise_heading' => 'Szakterületek',
    'home.expertise_dialysis' => 'Dialízis és vesepótló kezelések (hemodialízis, hemodiafiltráció, hemofiltráció)',
    'home.expertise_vascular' => 'Dialízishez használt érbemenetek ultrahangvizsgálata',
    'home.expertise_elimination' => 'Testen kívüli és testen belüli eliminációs kezelések',
    'home.expertise_plasma' => 'Membrános plazmaszeparáció és kapcsolódó kezelések',
    'home.expertise_transplant' => 'Veseátültetés',
    'home.teaching_text' => 'Kiterjedt tapasztalatom van a belgyógyászat, a diabetológia, a nefrológia és a kapcsolódó szakterületek oktatásában és előadásában. Emellett fordítóként is dolgozom: angol–szlovák és szlovák–angol orvosi szakfordítással, valamint szoftverlokalizációval foglalkozom.',
    'home.tech_text' => 'Az információtechnológia, az informatika és a programozás régóta végigkíséri a pályámat. Különösen az alábbiak érdekelnek:',
    'home.identity_doctor' => 'Orvos (Dr.)',
    'home.identity_nephrologist' => 'Nefrológus',
    'home.identity_internist' => 'Belgyógyász',
    'home.identity_translator' => 'Orvosi szakfordító',
    'home.identity_writer' => 'Szépirodalmi és tényirodalmi szerző',
    'home.identity_programmer' => 'Autodidakta programozó',
    'home.skills_heading' => 'Technológia, informatika és programozás',
    'home.education_heading' => 'Tanulmányok és pálya',
    'home.education_text' => 'Orvosi tanulmányaimat a kassai Pavol Jozef Šafárik Egyetemen kezdtem. 1995 óta a dialízisre és a nefrológiára összpontosítok. 2013 és 2022 között két pozsonyi dialízisközpont osztályvezető főorvosa voltam.',
    'home.personal_heading' => 'Személyes',
    'home.personal_text' => '1971-ben születtem Csehszlovákiában, Kyjovban nőttem fel. Ruszin gyökereim alakítják a világlátásomat. Szenvedélyeim az olvasás, az utazás, a filozófia és a költészet.',
    'home.amazon_cta' => 'Megtekintés az Amazon Author Centralon',
