...
return [
    ...
    'meta.default_description' => 'MUDr. Ľubomír Polaščín — nefrolog, internista, lékařský překladatel, spisovatel a programátor samouk.',
    'meta.home_title' => 'Domů',
    ...
    'home.hero_title' => 'Pokrok ve zdraví ledvin',
    'home.hero_subtitle' => 'MUDr. Ľubomír Polaščín — oddaný excelenci v nefrologii, dialýze, péči o pacienty a medicínských technologiích.',
    'home.cta_about' => 'O mně',
    'home.cta_articles' => 'Nejnovější články',

    // Domovská stránka — životopis
    'home.about_heading' => 'O MUDr. Ľubomíru Polaščínovi',
    'home.about_intro' => 'Jmenuji se Ľubomír Polaščín — jsem lékař, nefrolog a internista povoláním, spisovatel beletrie a literatury faktu posláním a programátor samouk z vášně.',
    'home.about_who' => 'Moje práce stojí na průsečíku medicíny, vyprávění příběhů a technologií. Medicína tříbí mou klinickou přesnost; psaní mi umožňuje zkoumat lidský úděl skrze beletrii i literaturu faktu; a technologie mě posouvají při řešení složitých problémů. Jako konzultant tyto světy propojuji a přináším promyšlená, dobře podložená řešení.',
    'home.who_heading' => 'Kdo jsem',
    'home.who_approach' => 'Ke každé výzvě přistupuji se zvědavostí a důsledností — ať už léčím pacienty, ladím kód, překládám náročný text nebo zkoumám umělou inteligenci.',
    'home.bio_heading' => 'Životopisné údaje',
    'home.bio_name' => 'Jméno',
    'home.bio_pronunciation' => 'Výslovnost',
    'home.bio_email' => 'E-mail',
    'home.bio_web' => 'Web',
    'home.bio_social' => 'Sociální sítě',
    'home.identity_heading' => 'Profesní identita',
    'home.identity_text' => 'Jsem lékař, který promoval ve všeobecném lékařství (1995) a atestoval z nefrologie (2009). Atestaci z vnitřního lékařství mám z roku 1998 a certifikát z abdominální ultrasonografie u dospělých z roku 2009.',
    'home.expertise_heading' => 'Oblasti odbornosti',
    'home.expertise_dialysis' => 'Dialýza a náhrada funkce ledvin (hemodialýza, hemodiafiltrace, hemofiltrace)',
    'home.expertise_vascular' => 'Ultrasonografie cévních přístupů pro dialýzu',
    'home.expertise_elimination' => 'Extrakorporální a intrakorporální eliminační metody',
    'home.expertise_plasma' => 'Membránová separace plazmy a související léčebné postupy',
    'home.expertise_transplant' => 'Transplantace ledvin',
    'home.teaching_text' => 'Mám rozsáhlé zkušenosti s výukou a přednášením ve vnitřním lékařství, diabetologii, nefrologii a příbuzných oborech. Věnuji se také překladům — anglicko-slovenským a slovensko-anglickým lékařským překladům a lokalizaci softwaru.',
    'home.tech_text' => 'Informační technologie, informatika a programování jsou mou dlouhodobou součástí. Zajímají mě zejména:',
    'home.identity_doctor' => 'Lékař (MUDr.)',
    'home.identity_nephrologist' => 'Nefrolog',
    'home.identity_internist' => 'Internista',
    'home.identity_translator' => 'Lékařský překladatel',
    'home.identity_writer' => 'Spisovatel beletrie a literatury faktu',
    'home.identity_programmer' => 'Programátor samouk',
    'home.skills_heading' => 'Technologie, IT a programování',
    'home.education_heading' => 'Vzdělání a kariéra',
    'home.education_text' => 'Své lékařské vzdělání jsem zahájil na Univerzitě Pavla Jozefa Šafárika v Košicích. Od roku 1995 se zaměřuji na dialýzu a nefrologii. V letech 2013 až 2022 jsem působil jako primář na dvou dialyzačních střediscích v Bratislavě.',
    'home.personal_heading' => 'Osobní',
    'home.personal_text' => 'Narodil jsem se v roce 1971 v Československu a vyrůstal jsem v Kyjově. Mé rusínské kořeny utvářejí můj pohled na svět. Mými zálibami jsou četba, cestování, filozofie a poezie.',
    'home.amazon_cta' => 'Zobrazit na Amazon Author Central',
