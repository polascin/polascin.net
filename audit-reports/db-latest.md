...
Generované: 2026-09-24 22:43:49 CEST  
...
| --- | --- | --- | --- |
| `access_logs` | InnoDB | utf8mb4_unicode_ci | 29178 |
| `admin_audit_log` | InnoDB | utf8mb4_unicode_ci | 20 |
| `articles` | InnoDB | utf8mb4_unicode_ci | 90 |
...
| `schema_migrations` | InnoDB | utf8mb4_unicode_ci | 17 |
...
| --- | --- | --- | --- |
| `access_logs` | 29178 | 2026-07-28 12:20:55 | 58 |
| `contact_messages` | 1 | 2026-09-23 22:32:11 | 1 |
...
| `form_rate_limit` | 4 | 2026-09-23 22:32:11 | 1 |
