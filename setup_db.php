...
function applySchemaMigrations(PDO $pdo): void {
    ...
    $migrations = [
        ...
        '2026091704_ai_model_freedom_article' => static function (PDO $pdo): void {
            seedPublishedArticleFromFile(
                $pdo,
        ...
        '2026092001_ai_author_phishing_email_article' => static function (PDO $pdo): void {
            seedPublishedArticleFromFile(
                $pdo,
        ...
        '2026092503_atlas_agents_cold_email_article' => static function (PDO $pdo): void {
            seedPublishedArticleFromFile(
                $pdo,
